      ...
      (ChatContext context, [String? selection]) async {
        ...
        switch (system) {
          case System.none:
            ...
            rolls = rollHelper(
                numberOfDice: numberOfDice, numberOfSides: sidesOfDice);
          ...
          case System.age:
            ...
            var sum =
                rolls.reduce((value, element) => value + element) + attMod;
            ...
            if (hasDuplicates) {
              await context.respond(MessageBuilder(
                  content:
                      'Rolled: ${rolls.toString()} + $attMod = $sum and generated ${rolls.last} stunt points!'));
              return;
            } else {
              await context.respond(MessageBuilder(
